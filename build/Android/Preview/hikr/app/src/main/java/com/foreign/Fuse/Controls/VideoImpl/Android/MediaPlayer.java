...
public class MediaPlayer
{
    ...
    {
        android.view.Window window = com.apps.hikr.hikr.GetRootActivity().getWindow();
        			...
        			try
        			{
        				android.content.pm.ActivityInfo info = com.apps.hikr.hikr.GetRootActivity().getPackageManager().getActivityInfo(com.apps.hikr.hikr.GetRootActivity().getComponentName(), 0);
    ...
    public static void Pause1212(final Object handle)
    {
        android.media.MediaPlayer player = (android.media.MediaPlayer)handle;
        			if (player.isPlaying())
        			{
        				android.media.AudioManager am = (android.media.AudioManager)com.apps.hikr.hikr.GetRootActivity().getSystemService(android.content.Context.AUDIO_SERVICE);
