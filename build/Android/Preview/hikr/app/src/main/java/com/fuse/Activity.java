...
//    #endif
    {
        return com.apps.hikr.hikr.RootActivity();
    }

    // - - - - - - - - - - - - - - - - - - - - - - - -

    public interface LifecycleListener extends com.apps.hikr.ActivityState.AndroidLifecycleListener {}

    public static void subscribeToLifecycleChange(LifecycleListener listener)
	{
        com.apps.hikr.hikr activity = (com.apps.hikr.hikr)getRootActivity();
