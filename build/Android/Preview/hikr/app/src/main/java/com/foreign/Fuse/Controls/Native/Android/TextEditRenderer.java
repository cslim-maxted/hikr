...
public class TextEditRenderer
{
    ...
    {
        android.widget.GridLayout gridLayout = new android.widget.GridLayout(com.apps.hikr.hikr.GetRootActivity());
    ...
    {
        android.widget.TextView tv = new android.widget.TextView(com.apps.hikr.hikr.GetRootActivity());
