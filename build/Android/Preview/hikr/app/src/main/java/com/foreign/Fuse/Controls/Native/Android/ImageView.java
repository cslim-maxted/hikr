...
public class ImageView
{
    ...
    public static Object Create73(final Object container)
    {
        android.widget.RelativeLayout relativeLayout = (android.widget.RelativeLayout)container;
        			android.widget.ImageView imageView = new android.widget.ImageView(com.apps.hikr.hikr.GetRootActivity());
    ...
    {
        android.widget.RelativeLayout relativeLayout = new android.widget.RelativeLayout(com.apps.hikr.hikr.GetRootActivity());
