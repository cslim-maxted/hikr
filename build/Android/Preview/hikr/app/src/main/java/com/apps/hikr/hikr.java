...
//#else
public class hikr extends android.app.Activity implements ActivityCompat.OnRequestPermissionsResultCallback
//#endif
{
...
//#endif
    ...
    {
    	hikr activity = _appState.CurrentActivity;
...
//#endif
    ...
    public static hikr RootActivity()
    {
        return _appState.CurrentActivity;
    }
