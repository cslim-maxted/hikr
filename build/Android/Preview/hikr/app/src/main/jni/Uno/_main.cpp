...
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* hikr_FuseControlsTextBox_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* hikr_FuseControlsTextView_Value_Property_typeof();}
...
void uInitRtti()
{
    static uType*(*factories[])() =
    {
        ...
        (uType*(*)())&::g::hikr_FuseControlsTextBox_Value_Property_typeof,
        (uType*(*)())&::g::hikr_FuseControlsTextView_Value_Property_typeof,
