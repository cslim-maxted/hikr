...
static void CircularRangeBehavior_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Primitives/0.38.6/rangecontrols/$.uno");
...
static void ScrollableGoto_build(uType* type)
{
    ...
    ::STRINGS[8] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.ScrollView/0.38.6/$.uno");
...
static void SwipeGesture_build(uType* type)
{
    ...
    ::STRINGS[14] = uString::Const("/usr/local/share/uno/Packages/Fuse.Gestures/0.38.6/$.uno");
    ::STRINGS[4] = uString::Const("OnRooted");
    ::TYPES[1] = ::g::Fuse::Elements::Element_typeof();
    type->SetInterfaces(
...
void SwipeGesture__OnRooted_fn(SwipeGesture* __this)
{
    ...
    if (element == NULL)
    {
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[13/*"Element"*/], __this->Parent(), __this, ::STRINGS[14/*"/usr/local/...*/], 929, ::STRINGS[4/*"OnRooted"*/]);
        return;
    }
