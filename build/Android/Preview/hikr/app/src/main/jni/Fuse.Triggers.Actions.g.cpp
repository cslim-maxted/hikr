...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[8] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/0.38.6/$.uno");
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[11] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/0.38.6/$.uno");
    ::STRINGS[9] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
...
void ReleasePage__Perform_fn(ReleasePage* __this, ::g::Fuse::Node* n)
{
    ...
    if ((v == NULL) || (nav == NULL))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[10/*"Requires a ...*/], __this, ::STRINGS[11/*"/usr/local/...*/], 283, ::STRINGS[9/*"Perform"*/]);
        return;
    }
