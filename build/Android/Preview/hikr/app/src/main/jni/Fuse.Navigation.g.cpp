...
void Router::Pop()
{
    ...
    if (uPtr(_history)->Count() == 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[40/*"Cannot pop(...*/], this, ::STRINGS[1/*"/usr/local/...*/], 2129, ::STRINGS[41/*"Pop"*/]);
        return;
    }
...
::g::Fuse::Navigation::Route* Router::SetRoute(::g::Fuse::Navigation::Route* r, int gotoMode, int operation, bool userRequest)
{
    ...
    if (outR == NULL)
    {
        ...
        if (userRequest)
            ::g::Fuse::Diagnostics::UserError(msg, this, ::STRINGS[1/*"/usr/local/...*/], 2151, ::STRINGS[43/*"SetRoute"*/]);
        else
            ::g::Fuse::Diagnostics::InternalError(msg, this, ::STRINGS[1/*"/usr/local/...*/], 2153, ::STRINGS[43/*"SetRoute"*/]);
...
::g::Fuse::Navigation::Route* Router::SetRouteImpl(::g::Fuse::Visual* root, ::g::Fuse::Navigation::Route* r, int gotoMode, int operation)
{
    ...
    if (outlet == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[44/*"No router o...*/], r), this, ::STRINGS[1/*"/usr/local/...*/], 2170, ::STRINGS[45/*"SetRouteImpl"*/]);
        return NULL;
    }
    ...
    if (r->SubRoute != NULL)
    {
        if (active == NULL)
        {
            ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[46/*"SubRoute re...*/], r), this, ::STRINGS[1/*"/usr/local/...*/], 2192, ::STRINGS[45/*"SetRouteImpl"*/]);
            return NULL;
        }
        else
        {
...
void Router::GetRoute(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[33/*"Router.getR...*/], r, ::STRINGS[1/*"/usr/local/...*/], 1856, ::STRINGS[34/*"GetRoute"*/]);
        return;
    }
    ...
    if (callback == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[35/*"Router.getR...*/], r, ::STRINGS[1/*"/usr/local/...*/], 1862, ::STRINGS[34/*"GetRoute"*/]);
        return;
    }
...
void Router::GoBack1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[36/*"GoBack take...*/], r, ::STRINGS[1/*"/usr/local/...*/], 1773, ::STRINGS[37/*"GoBack"*/]);
        return;
    }
...
void Router::Goto1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (where != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[38/*"Router.goto...*/], r, ::STRINGS[1/*"/usr/local/...*/], 1735, ::STRINGS[39/*"Goto"*/]);
}
...
bool Router::ValidateParameter(::g::Fuse::Scripting::Context* c, uObject* arg, int depth)
{
    ...
    if (depth > 50)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[47/*"Route param...*/], NULL, ::STRINGS[1/*"/usr/local/...*/], 1783, ::STRINGS[48/*"ValidatePar...*/]);
        return false;
    }
    ...
    if (uIs(arg, ::TYPES[43/*Fuse.Scripting.Object*/]))
    {
        ...
        {
            ::g::Fuse::Diagnostics::UserError(::STRINGS[49/*"Route param...*/], NULL, ::STRINGS[1/*"/usr/local/...*/], 1792, ::STRINGS[48/*"ValidatePar...*/]);
            return false;
        }
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[50/*"Route param...*/], NULL, ::STRINGS[1/*"/usr/local/...*/], 1815, ::STRINGS[48/*"ValidatePar...*/]);
        return false;
    }
...
void StructuredNavigation__FuseNavigationISeekableNavigationSeek_fn(StructuredNavigation* __this, ::g::Fuse::Navigation::UpdateSeekArgs* args)
{
    ...
    if (__this->_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[51/*"Seek being ...*/], __this, ::STRINGS[1/*"/usr/local/...*/], 2840, ::STRINGS[52/*"Fuse.Naviga...*/]);
        return;
    }
...
void StructuredNavigation::Duration(double value)
{
    ...
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[57/*"Use a `Navi...*/], this, ::STRINGS[1/*"/usr/local/...*/], 2740, ::STRINGS[58/*"set_Duration"*/]);
}
...
void StructuredNavigation::Easing(int value)
{
    ...
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[59/*"Use a `Navi...*/], this, ::STRINGS[1/*"/usr/local/...*/], 2731, ::STRINGS[60/*"set_Easing"*/]);
}
...
void StructuredNavigation::GotoImpl(::g::Fuse::Visual* element, int mode)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[53/*"Attempting ...*/], element, ::STRINGS[1/*"/usr/local/...*/], 2548, ::STRINGS[54/*"GotoImpl"*/]);
        SetActive(NULL);
        return;
    }
...
void StructuredNavigation::Motion(::g::Fuse::Motion::MotionConfig* value)
{
    ...
    if (IsRootingCompleted())
        ::g::Fuse::Diagnostics::UserError(::STRINGS[61/*"Motion shou...*/], this, ::STRINGS[1/*"/usr/local/...*/], 2483, ::STRINGS[62/*"set_Motion"*/]);
}
...
void StructuredNavigation::OnUpdated()
{
    ...
    if (_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[55/*"Updated cal...*/], this, ::STRINGS[1/*"/usr/local/...*/], 2639, ::STRINGS[56/*"OnUpdated"*/]);
        return;
    }
...
void SwipeNavigate::OnPointerPressed(uObject* sender, ::g::Fuse::Input::PointerPressedArgs* args)
{
    ...
    if (_currentNavigation == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[63/*"SwipeNaviga...*/], 1, ::STRINGS[1/*"/usr/local/...*/], 3180);
        return;
    }
...
void VisualNavigation::gotoNode(::g::Fuse::Scripting::Context* c, VisualNavigation* nav, uArray* args)
{
    ...
    if (target != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[65/*"Navigation....*/], nav, ::STRINGS[1/*"/usr/local/...*/], 3629, ::STRINGS[66/*"gotoNode"*/]);
}
// }
...
void WhileHistoryTrigger__OnRooted_fn(WhileHistoryTrigger* __this)
{
    ...
    if (__this->NavigationContext() == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[67/*"WhileHistor...*/], __this, ::STRINGS[1/*"/usr/local/...*/], 3883, ::STRINGS[7/*"OnRooted"*/]);
        return;
    }
...
void WhileNavigating__OnRooted_fn(WhileNavigating* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[68/*"WhileNaviga...*/], __this, ::STRINGS[1/*"/usr/local/...*/], 3964, ::STRINGS[7/*"OnRooted"*/]);
        return;
    }
