...
void Each__FuseScriptingIObserverOnRemoveAt_fn(Each* __this, int* index)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[29/*"Removing an...*/], __this, ::STRINGS[4/*"/usr/local/...*/], 848, ::STRINGS[30/*"Fuse.Script...*/]);
        return;
    }
...
void JavaScript::EvaluateModule()
{
...

    {
        ...
        if (newModuleResult->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[32/*"JavaScript ...*/], FileName()), ::STRINGS[33/*" fixed!"*/]), this, ::STRINGS[4/*"/usr/local/...*/], 1378, ::STRINGS[34/*"EvaluateMod...*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserScriptError(::STRINGS[35/*"JavaScript ...*/], se, this, ::STRINGS[4/*"/usr/local/...*/], 1389, ::STRINGS[34/*"EvaluateMod...*/]);
...
void Select::ctor_5()
{
    ...
    ctor_4();
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[48/*"Use the `Wi...*/], this, ::STRINGS[4/*"/usr/local/...*/], 2433, ::STRINGS[49/*".ctor"*/]);
}
...
void ThreadWorker::CheckAndThrow()
{
    ...
    {
        if (prev != NULL)
            ::g::Fuse::Diagnostics::UnknownException(::STRINGS[50/*"Skipped Exc...*/], next, this, ::STRINGS[4/*"/usr/local/...*/], 2028, ::STRINGS[51/*"CheckAndThrow"*/]);
...
void ThreadWorker::Run()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[52/*"ThreadWorke...*/], e, this, ::STRINGS[4/*"/usr/local/...*/], 1920, ::STRINGS[53/*"Run"*/]);
