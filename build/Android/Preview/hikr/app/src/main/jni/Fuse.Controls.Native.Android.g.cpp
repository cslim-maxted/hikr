...
static void Blitter_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::g::Uno::Graphics::VertexBuffer_typeof(), offsetof(::g::Fuse::Controls::Native::Android::Blitter, Blit_v_1da305ec_1_7_1), 0,
        ::g::Uno::Float2_typeof()->Array(), offsetof(::g::Fuse::Controls::Native::Android::Blitter, Blit_verts_1da305ec_1_6_5), 0,
...
void Blitter::Blit(::g::Uno::Graphics::Texture2D* vt, ::g::Uno::Float2 pos, ::g::Uno::Float2 size, ::g::Uno::Float4x4 localToClipTransform)
{
    ...
    _draw_1da305ec.Use();
    _draw_1da305ec.Attrib1(0, 2, Blit_v_1da305ec_1_7_1, 8, 0);
    ...
    _draw_1da305ec.DrawArrays(uPtr(Blit_verts_1da305ec_1_6_5)->Length());
}
...
void Blitter::init_DrawCalls()
{
    ...
    uArray* verts_1da305ec_1_6_0 = uArray::Init< ::g::Uno::Float2>(::TYPES[0/*float2[]*/], 6, ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(1.0f, 0.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(0.0f, 1.0f));
    Blit_v_1da305ec_1_7_1 = ::g::Uno::Graphics::VertexBuffer::New2(::g::Uno::Runtime::Implementation::Internal::BufferConverters::ToBuffer3(verts_1da305ec_1_6_0), 0);
    Blit_verts_1da305ec_1_6_5 = verts_1da305ec_1_6_0;
...
static void Shape_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Native/0.38.6/android/$.uno");
...
void Shape::SetBrush(::g::Java::Object* shapeDrawable, ::g::Fuse::Drawing::Brush* brush)
{
    ...
    else
    {
        ...
        if ((sc == NULL) && (ssc == NULL))
            ::g::Fuse::Diagnostics::Unsupported(::STRINGS[1/*""*/], brush, ::STRINGS[2/*"/usr/local/...*/], 1586, ::STRINGS[3/*"SetBrush"*/]);
...
void View::Background(::g::Fuse::Drawing::Brush* value)
{
    ...
    if (value != NULL)
    {
        ...
        if ((sc == NULL) && (ssc == NULL))
            ::g::Fuse::Diagnostics::Unsupported(::g::Uno::Object::ToString(this), value, ::STRINGS[2/*"/usr/local/...*/], 3098, ::STRINGS[5/*"set_Backgro...*/]);
    }
...
void View::Transform(::g::Uno::Float4x4 value)
{
    ...
    if (Parent() == NULL)
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition(this, ::STRINGS[6/*" is missing...*/]), 1, ::STRINGS[2/*"/usr/local/...*/], 3143);
    else
