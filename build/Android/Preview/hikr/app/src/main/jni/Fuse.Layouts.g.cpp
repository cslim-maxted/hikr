...
static void DefinitionBase_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Panels/0.38.6/layouts/$.uno");
...
DefinitionBase__ParseDataItem DefinitionBase::ParseDataSingle(uString* data)
{
    ...
    catch (const uThrowable& __t)
    {
        ...
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[4/*"Unable to p...*/], data), 1, ::STRINGS[5/*"/usr/local/...*/], 839);
...
void GridLayout::ColumnCount(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"ColumnCount...*/], this, ::STRINGS[5/*"/usr/local/...*/], 1185, ::STRINGS[7/*"set_ColumnC...*/]);
        return;
    }
...
uString* GridLayout::ColumnData()
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[8/*"GridLayout:...*/], 1, ::STRINGS[5/*"/usr/local/...*/], 1138);
    return Columns();
}
...
void GridLayout::ColumnData(uString* value)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[8/*"GridLayout:...*/], 1, ::STRINGS[5/*"/usr/local/...*/], 1143);
    Columns(value);
}
...
uString* GridLayout::RowData()
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[9/*"GridLayout:...*/], 1, ::STRINGS[5/*"/usr/local/...*/], 1068);
    return Rows();
}
...
void GridLayout::RowData(uString* value)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[9/*"GridLayout:...*/], 1, ::STRINGS[5/*"/usr/local/...*/], 1073);
    Rows(value);
}
