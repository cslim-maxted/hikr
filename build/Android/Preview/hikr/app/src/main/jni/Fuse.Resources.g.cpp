...
static void ImageSource_build(uType* type)
{
    ...
    ::STRINGS[11] = uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/0.38.6/resources/$.uno");
...
void ImageSource::OnError(uString* msg, ::g::Uno::Exception* e)
{
    ...
    ::g::Fuse::Diagnostics::UnknownException(::STRINGS[10/*"ImageSource...*/], e, this, ::STRINGS[11/*"/usr/local/...*/], 597, ::STRINGS[12/*"OnError"*/]);
