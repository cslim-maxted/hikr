...
static void Pointer_build(uType* type)
{
    ...
    ::STRINGS[10] = uString::Const("/usr/local/share/uno/Packages/FuseCore/0.38.6/input/$.uno");
...
bool Pointer::HardCapture(int pointIndex, ::g::Fuse::Visual* node, uObject* identity, uDelegate* lostCallback)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[9/*"HardCapture...*/], 1, ::STRINGS[10/*"/usr/local/...*/], 1187);
        return false;
    }
...
bool Pointer::SoftCapture(int pointIndex, ::g::Fuse::Visual* softCapturer, uObject* identity, uDelegate* lostCallback)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[14/*"SoftCapture...*/], 1, ::STRINGS[10/*"/usr/local/...*/], 1096);
        return false;
    }
