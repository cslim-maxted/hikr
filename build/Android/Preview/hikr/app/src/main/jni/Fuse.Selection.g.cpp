...
void Selection__FuseScriptingIObserverOnFailed_fn(Selection* __this, uString* message)
{
    ...
    ::g::Fuse::Diagnostics::InternalError(message, __this, ::STRINGS[4/*"/usr/local/...*/], 878, ::STRINGS[21/*"Fuse.Script...*/]);
}
...
void Selection__FuseScriptingIObserverOnInsertAt_fn(Selection* __this, int* index, uObject* value)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[22/*"removing in...*/], __this, ::STRINGS[4/*"/usr/local/...*/], 869, ::STRINGS[23/*"Fuse.Script...*/]);
        return;
    }
...
void Selection__FuseScriptingIObserverOnNewAt_fn(Selection* __this, int* index, uObject* newValue)
{
    ...
    if ((index_ < 0) || (index_ >= uPtr(__this->_values)->Count()))
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[22/*"removing in...*/], __this, ::STRINGS[4/*"/usr/local/...*/], 834, ::STRINGS[24/*"Fuse.Script...*/]);
        return;
    }
...
void Selection__FuseScriptingIObserverOnRemoveAt_fn(Selection* __this, int* index)
{
    ...
    if ((index_ < 0) || (index_ >= uPtr(__this->_values)->Count()))
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[22/*"removing in...*/], __this, ::STRINGS[4/*"/usr/local/...*/], 858, ::STRINGS[25/*"Fuse.Script...*/]);
        return;
    }
...
void Selection::MaxCount(int value)
{
    ...
    if (value < 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[28/*"MaxCount mu...*/], this, ::STRINGS[4/*"/usr/local/...*/], 549, ::STRINGS[29/*"set_MaxCount"*/]);
        return;
    }
...
void Selection::Values(uObject* value)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[31/*"`Values` mu...*/], this, ::STRINGS[4/*"/usr/local/...*/], 785, ::STRINGS[32/*"set_Values"*/]);
        return;
    }
...
void ToggleSelection__Perform_fn(ToggleSelection* __this, ::g::Fuse::Node* target)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[35/*"Unable to l...*/], __this, ::STRINGS[4/*"/usr/local/...*/], 942, ::STRINGS[36/*"Perform"*/]);
        return;
    }
...
void WhileSelected__OnRooted_fn(WhileSelected* __this)
{
    ...
    if (!::g::Fuse::Selection::Selection::TryFindSelectable(__this->Parent(), &__this->_selectable, &__this->_selection))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[33/*"Unable to l...*/], __this, ::STRINGS[4/*"/usr/local/...*/], 990, ::STRINGS[8/*"OnRooted"*/]);
        return;
    }
