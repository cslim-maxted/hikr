...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/0.38.6/triggers/$.uno
// ----------------------------------------------------------------------------
...
static void ContainingText_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Primitives/0.38.6/triggers/$.uno");
...
static void LayoutAnimation_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/0.38.6/triggers/$.uno");
...
static void OnUserEvent_build(uType* type)
{
    ...
    ::STRINGS[12] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/0.38.6/$.uno");
    ::STRINGS[10] = uString::Const("OnRooted");
...
static void PageBeginLoading_build(uType* type)
{
    ...
    ::STRINGS[14] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.WebView/0.38.6/$.uno");
    ::STRINGS[10] = uString::Const("OnRooted");
...
void PageBeginLoading__OnRooted_fn(PageBeginLoading* __this)
{
    ...
    if (uIs((::g::Fuse::Visual*)__this->Parent(), ::TYPES[25/*Fuse.Controls.IWebView*/]))
    {
        ...
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[13/*"WebView"*/], __this->Parent(), __this, ::STRINGS[14/*"/usr/local/...*/], 972, ::STRINGS[10/*"OnRooted"*/]);
}
...
void PageLoaded__OnRooted_fn(PageLoaded* __this)
{
    ...
    if (uIs((::g::Fuse::Visual*)__this->Parent(), ::TYPES[25/*Fuse.Controls.IWebView*/]))
    {
        ...
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[13/*"WebView"*/], __this->Parent(), __this, ::STRINGS[14/*"/usr/local/...*/], 1031, ::STRINGS[10/*"OnRooted"*/]);
}
...
static void RemovingAnimation_build(uType* type)
{
    ...
    ::STRINGS[16] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/0.38.6/$.uno");
...
void RemovingAnimation__FuseIBeginRemoveVisualListenerOnBeginRemoveVisual_fn(RemovingAnimation* __this, ::g::Fuse::PendingRemoveVisual* pr)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[15/*"Double remo...*/], __this, ::STRINGS[16/*"/usr/local/...*/], 1230, ::STRINGS[17/*"Fuse.IBegin...*/]);
        return;
    }
...
void RemovingAnimation::OnDone()
{
    ...
    if (_args == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[18/*"Unexpected ...*/], this, ::STRINGS[16/*"/usr/local/...*/], 1243, ::STRINGS[19/*"OnDone"*/]);
        return;
    }
...
static void Scrolled_build(uType* type)
{
    ...
    ::STRINGS[22] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.ScrollView/0.38.6/triggers/$.uno");
...
void State::Goto()
{
    ...
    if (_stateGroup == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[26/*"Cannot call...*/], NULL, ::STRINGS[16/*"/usr/local/...*/], 1650, ::STRINGS[27/*"Goto"*/]);
        return;
    }
...
void StateGroup::goto_(::g::Fuse::Scripting::Context* c, StateGroup* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[29/*"StateGroup....*/], n, ::STRINGS[16/*"/usr/local/...*/], 1313, ::STRINGS[30/*"goto_"*/]);
        return;
    }
...
void StateGroup::gotoName(::g::Fuse::Scripting::Context* c, StateGroup* n, uString* name)
{
    ...
    if (state == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[31/*"Unable to f...*/], name), n, ::STRINGS[16/*"/usr/local/...*/], 1293, ::STRINGS[32/*"gotoName"*/]);
        return;
    }
...
void Timeline::playTo(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[44/*"Timeline.se...*/], n, ::STRINGS[16/*"/usr/local/...*/], 1970, ::STRINGS[40/*"playTo"*/]);
        return;
    }
...
void Timeline::seek(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[44/*"Timeline.se...*/], n, ::STRINGS[16/*"/usr/local/...*/], 2019, ::STRINGS[42/*"seek"*/]);
        return;
    }
...
void Trigger__FuseAnimationsIPlayerFeedbackOnPlaybackDone_fn(Trigger* __this, uObject* s)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[48/*"Trigger.OnP...*/], __this, ::STRINGS[16/*"/usr/local/...*/], 2352, ::STRINGS[49/*"Fuse.Animat...*/]);
        return;
    }
...
void Trigger::AddContent(::g::Fuse::Node* target)
{
    ...
    if (Parent() == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[45/*"AddContent ...*/], this, ::STRINGS[16/*"/usr/local/...*/], 2261, ::STRINGS[46/*"AddContent"*/]);
        return;
    }
    ...
    if (where == -1)
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[47/*"Could not l...*/], this), this, ::STRINGS[16/*"/usr/local/...*/], 2269, ::STRINGS[46/*"AddContent"*/]);
        return;
    }
...
void WhileContainsText__OnRooted_fn(WhileContainsText* __this)
{
    ...
    if (__this->_value != NULL)
    {
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[51/*"No TextInpu...*/], __this, ::STRINGS[6/*"/usr/local/...*/], 51, ::STRINGS[10/*"OnRooted"*/]);
}
...
void WhilePageLoading__OnRooted_fn(WhilePageLoading* __this)
{
    ...
    if (uIs((::g::Fuse::Visual*)__this->Parent(), ::TYPES[25/*Fuse.Controls.IWebView*/]))
    {
        ...
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[13/*"WebView"*/], __this->Parent(), __this, ::STRINGS[14/*"/usr/local/...*/], 750, ::STRINGS[10/*"OnRooted"*/]);
}
...
void WhileValue::Pulse1()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[54/*"`Pulse` on ...*/], this, ::STRINGS[16/*"/usr/local/...*/], 3671, ::STRINGS[55/*"Pulse"*/]);
...
void WhileVisibleInScrollView__OnRooted_fn(WhileVisibleInScrollView* __this)
{
    ...
    if (__this->_scrollable == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[56/*"Could not f...*/], __this, ::STRINGS[22/*"/usr/local/...*/], 899, ::STRINGS[10/*"OnRooted"*/]);
        return;
    }
    ...
    if (__this->_element == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[57/*"Parent must...*/], __this, ::STRINGS[22/*"/usr/local/...*/], 906, ::STRINGS[10/*"OnRooted"*/]);
        return;
    }

    if (!uPtr(__this->_element)->HasLayoutIn(__this->_scrollable))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[58/*"Must have a...*/], __this, ::STRINGS[22/*"/usr/local/...*/], 912, ::STRINGS[10/*"OnRooted"*/]);
        return;
    }
