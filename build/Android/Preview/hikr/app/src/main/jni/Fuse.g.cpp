...
static void Deferred_build(uType* type)
{
    ...
    ::STRINGS[11] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/0.38.6/$.uno");
...
void Deferred__FuseIDeferredPerform_fn(Deferred* __this)
{
    ...
    if (__this->_added != NULL)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[10/*"Duplicate c...*/], __this, ::STRINGS[11/*"/usr/local/...*/], 492, ::STRINGS[12/*"Fuse.IDefer...*/]);
...
void DrawContext::CaptureRootbuffer()
{
    ...
    CheckGLError(::STRINGS[5/*"/usr/local/...*/], 923, ::STRINGS[27/*"CaptureRoot...*/]);
...
void DrawContext::Clear(::g::Uno::Float4 color, float depth)
{
    ...
    CheckGLError(::STRINGS[5/*"/usr/local/...*/], 1062, ::STRINGS[28/*"Clear"*/]);
}
...
void DrawContext::GLFramebuffer(uint32_t value)
{
    ...
    CheckGLError(::STRINGS[5/*"/usr/local/...*/], 980, ::STRINGS[36/*"set_GLFrame...*/]);
}
...
void DrawContext::GLScissor(::g::Uno::Int4 value)
{
    ...
    CheckGLError(::STRINGS[5/*"/usr/local/...*/], 1103, ::STRINGS[37/*"set_GLScissor"*/]);
}
...
void DrawContext::GLViewportPixelSize(::g::Uno::Int2 value)
{
    ...
    CheckGLError(::STRINGS[5/*"/usr/local/...*/], 1147, ::STRINGS[38/*"set_GLViewp...*/]);
}
...
void DrawContext::PopRenderTarget()
{
    ...
    CheckGLError(::STRINGS[5/*"/usr/local/...*/], 1024, ::STRINGS[29/*"PopRenderTa...*/]);
...
void DrawContext::PushRenderTarget2(::g::Uno::Graphics::RenderTarget* rt, ::g::Uno::Int2 viewportPixelSize, ::g::Uno::Int4 glscissor)
{
    ...
    CheckGLError(::STRINGS[5/*"/usr/local/...*/], 1009, ::STRINGS[30/*"PushRenderT...*/]);
    _renderTarget = rt;
...
void DrawContext::ReleaseRootbuffer()
{
    ...
    if (uPtr(_glScissors)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[31/*"Unpopped Sc...*/], this, ::STRINGS[5/*"/usr/local/...*/], 940, ::STRINGS[32/*"ReleaseRoot...*/]);

    uPtr(_glScissors)->Clear();

    if (uPtr(_cullFaces)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[33/*"Unpopped Cu...*/], this, ::STRINGS[5/*"/usr/local/...*/], 944, ::STRINGS[32/*"ReleaseRoot...*/]);

    uPtr(_cullFaces)->Clear();

    if (uPtr(_viewports)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[34/*"Unpopped Vi...*/], this, ::STRINGS[5/*"/usr/local/...*/], 948, ::STRINGS[32/*"ReleaseRoot...*/]);

    uPtr(_viewports)->Clear();

    if (uPtr(_renderTargets)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[35/*"Unpopped Re...*/], this, ::STRINGS[5/*"/usr/local/...*/], 952, ::STRINGS[32/*"ReleaseRoot...*/]);
...
void GraphicsWorker::Run()
{
    ...
    while (!GraphicsWorker::_terminating())
    {
        ...
        if ((::g::Uno::Threading::ConcurrentQueue__TryDequeue_fn(uPtr(GraphicsWorker::_work()), (void**)(&a), &ret2), ret2))
        {
            ...
            {
                ::g::Uno::Exception* e = __t.Exception;
                ::g::Fuse::Diagnostics::UnknownException(::STRINGS[45/*"GraphicsWor...*/], e, a, ::STRINGS[5/*"/usr/local/...*/], 2452, ::STRINGS[46/*"Run"*/]);
...
// /usr/local/share/uno/Packages/Fuse.Entities/0.38.6/processing/$.uno
// -------------------------------------------------------------------
...
LayoutParams LayoutParams::DeriveClone()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[47/*"Use CloneAn...*/], uBox(LayoutParams_typeof(), *this), ::STRINGS[5/*"/usr/local/...*/], 2965, ::STRINGS[48/*"DeriveClone"*/]);
...
LayoutParams LayoutParams::TrueClone()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[49/*"Use Clone i...*/], uBox(LayoutParams_typeof(), *this), ::STRINGS[5/*"/usr/local/...*/], 2936, ::STRINGS[50/*"TrueClone"*/]);
...
static void UserEvent_build(uType* type)
{
    ...
    ::STRINGS[65] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/0.38.6/$.uno");
...
void UserEvent__OnRooted_fn(UserEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[64/*"UserEvent r...*/], __this, ::STRINGS[65/*"/usr/local/...*/], 638, ::STRINGS[66/*"OnRooted"*/]);
        return;
    }
...
void UserEvent::Raise(::g::Uno::Collections::Dictionary* args)
{
    ...
    if (Dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[69/*"Trying to R...*/], this, ::STRINGS[65/*"/usr/local/...*/], 685, ::STRINGS[70/*"Raise"*/]);
        return;
    }
...
void UserEvent::raise(::g::Fuse::Scripting::Context* c, UserEvent* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[67/*"Raise must ...*/], n, ::STRINGS[65/*"/usr/local/...*/], 421, ::STRINGS[63/*"raise"*/]);
        return;
    }
    ...
    if (so == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[68/*"Raise must ...*/], uPtr(args)->Strong<uObject*>(0), ::STRINGS[65/*"/usr/local/...*/], 428, ::STRINGS[63/*"raise"*/]);
        return;
    }
...
void UserEvent::RaiseEvent(::g::Fuse::Visual* from, ::g::Uno::UX::Selector name, ::g::Uno::Collections::Dictionary* args)
{
    ...
    if (ev == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition2(::STRINGS[71/*"Unknown eve...*/], ::g::Uno::UX::Selector__op_Implicit1(name)), NULL, ::STRINGS[65/*"/usr/local/...*/], 698, ::STRINGS[72/*"RaiseEvent"*/]);
        return;
    }
...
void VisualEvent::Raise(::g::Fuse::VisualEventArgs* args, int type, bool bubble, uDelegate* PostBubbleAction)
{
    ...
    switch (type)
    {
        ...
        default:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[81/*"Invalid Rai...*/], 1, ::STRINGS[5/*"/usr/local/...*/], 1672);
            return;
        }
    }
