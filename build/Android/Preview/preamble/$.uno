...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.10.78"), 12124)}, "/Users/chulseunglim/Documents/Fuse/projects/hikr/hikr.unoproj", GetBundle, new string[] { })
{
